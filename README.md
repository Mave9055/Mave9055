...
- **[WRH Master Curriculum](https://github.com/Mave9055/wrh-master-curriculum)** — 75-session curriculum architecture, procurement-facing documentation, facilitator standardization, and program structure.
- **[WRH Pilot Deployment Package](https://github.com/Mave9055/WRH-Pilot-Deployment-Package)** — 30-session pilot package with facilitator tools, participant supports, diagrams, outcomes structure, and implementation documents.
- **[Top 10 Core](https://github.com/Mave9055/top-10-core)** — 5-week accelerated introduction covering ten core survival laws.
...
- **[Book Production Workflow](https://github.com/Mave9055/from-storm-to-fire-book-production)** — repeatable Markdown-to-PDF ebook production system for branded exports.

### Company and Implementation
- **[Capitol Contracts](https://github.com/Mave9055/capitol-contracts)** — company repository and future public business documentation hub.
